    ...
    export default {
      ...
      methods: {
        ...
        submit(){
          ...
          var params = {
              "name": this.actively.activelyName,//名称
              "start_time": this.actively.activelyNewTime + 'T00:00',//开始时间
              "end_time": this.actively.activelyOldTime + 'T00:00', //结束时间
              "activity": this.actively.activelyCity,//活动地址
              "goods_num": this.actively.activelyPeopleNumber,//可参与人数
              "principal_telephone": this.actively.activelyLinkPhone,//电话
              "front_image": this.actively.activelyMainImg,//首页图
              "good_details": this.actively.activelyPosterImg//活动详情图
          }
          this.isLoading = true
